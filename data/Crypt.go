...
// The Lord of the Crypt resides here.
...
func encodePassword(plaintext string, p *cryptParams) (encodedHash string, err error) {
...
func decodeHash(encodedHash string) (p *cryptParams, salt, hash []byte, err error) {
